            ...
            <tbody class="bg-white text-black drop-shadow-md ">
                ...
                <tr class="hover:bg-gray-200">
                    ...
                    <td class="p-4 whitespace-nowrap space-x-2">
                        <button onclick="console.log({{$product->id}})" data-modal-target="product-modal-{{ $product->id }}" data-modal-toggle="product-modal-{{ $product->id }}" class="text-white bg-orange-500 hover:bg-orange-600 focus:ring-2 focus:ring-red-200 font-medium rounded-lg text-sm inline-flex items-center px-3 py-2 text-center">
