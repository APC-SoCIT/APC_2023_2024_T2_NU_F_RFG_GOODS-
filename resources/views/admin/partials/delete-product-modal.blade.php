    ...
    <div class="relative w-full max-w-md px-4 h-full md:h-auto">
        ...
        <div class="bg-white rounded-lg shadow relative">
            ...
            <div class="p-6 pt-0 text-center">
                ...
                <a href="" data-modal-toggle="delete-product-modal-{{ $product->id }}" class="text-gray-900 bg-white hover:bg-gray-100 focus:ring-4 focus:ring-cyan-200 border border-gray-200 font-medium inline-flex items-center rounded-lg text-base px-3 py-2.5 text-center" data-modal-toggle="delete-product-modal">
                    No, cancel
                </a>
            </div>
        </div>
