...
<aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full sm:translate-x-0 bg-white drop-shadow-md" aria-label="Sidebar">
   <div class="h-full px-3 pb-4 overflow-y-auto bg-white drop-shadow-md">
      <ul class="space-y-2 font-medium">
         ...
         <li>
            <a href="/dashboard" class="@if(request()->is('dashboard')) bg-orange-400 text-white @endif text-black flex items-center p-2 rounded-lg hover:bg-gray-300 group">
         ...
         <li>
            <a href="/admin/categories" class="@if(request()->is('admin/categories')) bg-orange-400 text-white @endif flex items-center p-2 rounded-lg text-black hover:bg-gray-300 group">
         ...
         <li>
            <a href="/admin/products" class="@if(request()->is('admin/products')) bg-orange-400 text-white @endif flex items-center p-2 rounded-lg text-black hover:bg-gray-300 group">
         ...
         <li>
            <a href="/admin/inventory" class="@if(request()->is('admin/inventory')) bg-orange-400 text-white @endif flex items-center p-2 rounded-lg text-black hover:bg-gray-300 group">
         ...
         <li>
            <a href="/admin/orders" class="@if(request()->is('admin/orders')) bg-orange-400 text-white @endif flex items-center p-2 rounded-lg text-black hover:bg-gray-300 group">
         ...
         <li>
            <a href="/admin/delivery" class="@if(request()->is('admin/delivery')) bg-orange-400 text-white @endif flex items-center p-2 rounded-lg text-black hover:bg-gray-300 group">
