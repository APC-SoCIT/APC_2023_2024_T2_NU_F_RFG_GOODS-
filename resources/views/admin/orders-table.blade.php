            ...
            @foreach ($orders as $order)
                <tr class="hover:bg-gray-100">
                    ...
                    <td class="p-4 whitespace-nowrap space-x-2">
                        <button data-modal-target="order-modal-{{ $order->id }}" data-modal-toggle="order-modal-{{ $order->id }}" class="text-white bg-orange-500 hover:bg-cyan-700 focus:ring-4 focus:ring-cyan-200 font-medium rounded-lg text-sm inline-flex items-center px-3 py-2 text-center">
