                ...
                @foreach ($inventories as $inventory)
                    <tr class="hover:bg-gray-100">
                        ...
                        <td class="p-4 whitespace-nowrap space-x-2">
                            <button data-modal-target="inventory-modal-{{ $inventory->id }}" data-modal-toggle="inventory-modal-{{ $inventory->id }}" class="text-white bg-orange-500 hover:bg-orange-600 focus:ring-2 focus:ring-red-200 font-medium rounded-lg text-sm inline-flex items-center px-3 py-2 text-center">
