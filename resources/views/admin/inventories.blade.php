                    ...
                    <div class="sm:flex">
                        <div class="hidden sm:flex items-center sm:divide-x sm:divide-gray-100 mb-3 sm:mb-0">
                            ...
                            <div class="flex space-x-1 pl-0 sm:pl-2 mt-3 sm:mt-0">
                                <a href="#" class="text-black hover:text-gray-900 cursor-pointer p-1 hover:bg-gray-100 rounded inline-flex justify-center">
                ...
                <div class="relative w-full max-w-2xl px-4 h-full md:h-auto">
                    ...
                    <div class="bg-white rounded-lg shadow relative">
                        ...
                        <div class="items-center p-6 border-t border-gray-200 rounded-b">
                            <button class="text-white bg-orange-500 hover:bg-orange-800 focus:ring-4 focus:ring-cyan-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center" type="submit">Add inventory</button>
                        </div>
                        </form>
                    </div>
                </div>
