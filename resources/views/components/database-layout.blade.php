<div class="p-4 block sm:flex items-center justify-between border-b border-rfg-secondary lg:mt-1.5">
    <div class="mb-1 w-full">
        ...
        <div class="mb-4">
            ...
            <h1 class="text-xl sm:text-2xl font-semibold text-rfg-text">All {{ $title }}</h1>
        </div>
