    ...
    <div class="flex flex-wrap items-center justify-between mx-auto p-2.5">
        ...
        <div class="justify-self-end hidden w-full md:flex md:w-auto md:order-1 ml-auto mr-4" id="navbar-search">
            ...
            <ul class="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 bg-orange-400">
                <li>
                    <a href="/" class="block py-2 px-3 text-white rounded hover:bg-orange-500 md:bg-transparent md:p-0 md:dark:hover:text-white sm:hover:bg-orange-500" aria-current="page">
                ...
                <li>
                    <a href="#" class="block py-2 px-3 text-white rounded hover:bg-orange-500 md:hover:bg-orange-300 sm:hover:bg-orange-500 md:hover:text-blue-700 md:p-0 md:dark:hover:text-white md:dark:hover:bg-orange-500">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                ...
                <li>
                    <a href="/cart" class="block py-2 px-3 text-white rounded hover:bg-orange-500 md:hover:bg-transparent md:hover:text-white md:p-0 md:dark:hover:text-white sm:hover:bg-orange-500 md:dark:hover:bg-orange-500">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
