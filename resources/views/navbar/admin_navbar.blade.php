  ...
  <div class="flex flex-wrap items-center justify-between mx-auto p-2.5">
      ...
      <div class="justify-self-end hidden w-full md:flex md:w-auto md:order-1 ml-auto" id="navbar-search">
          ...
          <ul class="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 bg-orange-400">
              <li>
                  <a href="/" class="block py-2 px-3 text-white rounded hover:bg-gray-200 md:hover:bg-transparent md:p-0 md:dark:hover:text-gray-300" aria-current="page">
              ...
              <li>
                  <a href="#" class="block py-2 px-3 text-white rounded hover:bg-orange-300 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-gray-300 md:dark:hover:bg-transparent">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
              ...
              <li>
                  <a href="/cart" class="block py-2 px-3 text-white rounded hover:bg-orange-300 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-gray-300 md:dark:hover:bg-transparent">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
              ...
              @if (Auth::user()!=null)
                  <li>
                      <button id="dropdownNavbarLink" data-dropdown-toggle="dropdownNavbar" class="flex items-center justify-between w-full py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-gray-300 md:p-0 md:w-auto dark:text-white md:dark:hover:text-gray-300 dark:focus:text-white dark:border-orange-600 dark:hover:bg-orange-500 md:dark:hover:bg-transparent">
                      ...
                      <div id="dropdownNavbar" class="z-10 hidden font-normal bg-white divide-y divide-white rounded-lg shadow w-44 dark:bg-orange-400 dark:divide-white">
                          <ul class="py-2 text-sm text-white dark:text-white" aria-labelledby="dropdownLargeButton">
                              <li>
                                  <a href="{{ route('dashboard') }}" class="block px-4 py-2 md:dark:hover:text-gray-300 dark:hover:text-white md:hover:bg-transparent">Dashboard</a>
                              </li>
                          </ul>
                          <ul class="py-2 text-sm text-white dark:text-white" aria-labelledby="dropdownLargeButton">
                            <li>
                                <a href="{{ route('profile.edit') }}" class="block px-4 py-2 md:dark:hover:text-gray-300 dark:hover:text-white md:hover:bg-transparent">Profile</a>
                            </li>
                        </ul>
                          <div class="py-1">
                              <form method="POST" action="{{ route('logout') }}">
                                  @csrf
                                  <a class="block px-4 py-2 text-sm text-white md:dark:hover:text-gray-300 dark:text-white dark:hover:text-white md:hover:bg-transparent">
